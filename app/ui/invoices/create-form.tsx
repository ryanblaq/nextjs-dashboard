    ...
    <form action={formAction}>
      <div className="rounded-md bg-gray-50 dark:bg-slate-700 p-4 md:p-6">
        ...
        <div className="mb-4">
          ...
          <div className="relative mt-2 rounded-md dark:bg-slate-300">
            <div className="relative">
              <input
                id="amount"
                name="amount"
                ...
                className="peer block w-full rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500 dark:bg-slate-100"
        ...
        <fieldset>
          ...
          <div className="rounded-md border border-gray-200 bg-white dark:bg-slate-100 px-[14px] py-3">
            <div className="flex gap-4">
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="pending"
                  className="h-4 w-4 cursor-pointer border-gray-800 bg-gray-100 text-gray-600 focus:ring-2"
                />
                <label
                  htmlFor="pending"
